(function($) {
	...
	if ($('.header-carousel').length) {
		$('.header-carousel').addClass('active');
	...
	$('.wa-share').each(function() {
		var url = window.location;
		var title = $('.blog-title').text();
		var text = title + decodeURIComponent('%0A') + url;
		$(this).attr('href', 'https://api.whatsapp.com/send?text=' + encodeURIComponent(text));
	});
	
	$('.fb-share').each(function() {
		var url = encodeURIComponent(window.location);
		var title = encodeURIComponent($('.blog-title').text());
		$(this).attr('href', 'https://www.facebook.com/sharer.php?u=' + url + '&t=' + title);
	});

	$('.t-share').each(function() {
		var url = encodeURIComponent(window.location);
		var title = encodeURIComponent($('.blog-title').text());
		$(this).attr('href', 'https://twitter.com/share?url=' + url + '&title=' + title);
	});
